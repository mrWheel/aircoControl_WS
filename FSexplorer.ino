/*
***************************************************************************  
**  Program  : FSexplorer, part of aircoControl
**  Version  : v0.1.0 (WS)
**
...
void handleRoot() {                     // HTML FSexplorer
  ...
  FSexplorerHTML += "</head>";
  FSexplorerHTML += "<body><h1>aircoControl FSexplorer</h1><h2>Upload, Download of Verwijder</h2>";
  ...
  FSexplorerHTML += "  <form style='float: left;' action='/ReBoot' method='POST'>ReBoot aircoControl ";
...
void handleReBoot() {
  ...
  redirectHTML += "</style>";
  redirectHTML += "<title>Redirect to aircoControl</title>";
  redirectHTML += "</head>";
  redirectHTML += "<body><h1>aircoControl Onderhoud</h1>";
  redirectHTML += "<h3>Rebooting aircoControl</h3>";
  ...
  redirectHTML += "<br><br><hr>If you are not redirected automatically, click this <a href='/'>aircoControl</a>.";
  redirectHTML += "  <script>";
  ...
  TelnetStream.println("ReBoot aircoControl ..");
  TelnetStream.flush();
  delay(1000);
  ESP.reset();
